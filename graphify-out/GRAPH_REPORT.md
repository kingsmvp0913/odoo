...
## Corpus Check
- 52455 files · ~37,720,340 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 158 nodes · 189 edges · 31 communities (19 shown, 12 thin omitted)
- Extraction: 97% EXTRACTED · 3% INFERRED · 0% AMBIGUOUS · INFERRED: 6 edges (avg confidence: 0.83)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `4e211442`
...
3. `enabledPlugins` - 8 edges
4. `BackToConfirm()` - 7 edges
5. `project_version_map` - 7 edges
6. `project_dir_map` - 7 edges

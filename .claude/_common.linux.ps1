# =========================================================
# SHARED PIPELINE FUNCTIONS - sourced by analysis.linux.ps1 / test_coding.linux.ps1 / coding.linux.ps1
# =========================================================
...
function Release-Lock {
    ...
    try {
        ...
        if ($lock.pid -eq $PID -and $lock.host -eq [System.Net.Dns]::GetHostName()) {
            Remove-Item $lockPath -Force -ErrorAction SilentlyContinue
        }
    }

...
# Python 虛擬環境（必須）
PYTHON = "C:/odoo/venv_odoo19/Scripts/python.exe"
# Odoo 主程式
ODOO_BIN = "C:/odoo/odoo-19.0/odoo-bin"
# Odoo 設定檔
ODOO_CONF = "C:/odoo/odoo-19.0/odoo.conf"
# 客製模組資料夾（只掃這裡做 auto upgrade 判斷）
ADDONS_PATH = "C:/odoo/odoo-19.0/custom_addons"
